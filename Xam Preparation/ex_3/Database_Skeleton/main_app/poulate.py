...
def populate_model_with_data(model, num_records=10):
    ...
    for _ in range(num_records):
        ...
        for field in model_fields:
            ...
            # Handle FloatField for specific field names
            elif isinstance(field, FloatField) and field.name == "rating":
                field_values[field.name] = round(random.uniform(1.0, 5.0), 1)  # Ensure rating is between 1.0 and 5.0
